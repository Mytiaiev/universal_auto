...
from auto_bot.handlers.main.handlers import start, update_phone_number, helptext, get_id, cancel, error_handler, \
    more_function, start_query, get_about_us, get_privacy_police, get_contact_offer
...
def setup_dispatcher(dp):
    ...
    dp.add_handler(CallbackQueryHandler(get_privacy_police, pattern="Privacy_police"))
    dp.add_handler(CallbackQueryHandler(get_contact_offer, pattern="Contract_offer"))
