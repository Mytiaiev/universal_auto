...
personal_driver_text = "Основна ідея послуги <Персональний водій> полягає в наданні клієнту професійного водія," \
                       ...
                       "Умови даної послуги від Ninja Taxi:\n" \
                       "1.Ціна послуги визначається залежно від тривалості подорожі. Мінімальний час замовлення 2 години або 50 км.\n" \
                       "2.Вартість послуги 500₴ за годину або 25км поїздки\n" \
                       "3.Тарифікація погодинна\n" \
