...
bad_response_portmone = 'Зараз спостергіється велике навантаження на систему.\n' \
                        'Щоб повернути кошти, повідомте нам\n'\
                        'Наші дані:\n'\
                        f'Номер телефону: {ParkSettings.get_value("NINJA_PHONE")}\n'\
                        f'Пошта: {ParkSettings.get_value("NINJA_EMAIL")}\n'\ 
                        f'Адреса: {ParkSettings.get_value("NINJA_ADDRESS")}\n'\
                        'ID оплати: '
