settings = {
    ...
    'NINJA_PHONE': ('+38(093) 753 10 57', 'Номер телефону Ninja автопарку'),
    'NINJA_EMAIL': ('150', 'Електрона почта Ninja автопарку'),
    'NINJA_ADDRESS': ('150', 'Адреса офіса Ninja автопарку'),
}
