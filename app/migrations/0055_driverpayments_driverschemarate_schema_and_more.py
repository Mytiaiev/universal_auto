# Generated by Django 4.1 on 2023-10-03 12:46
...
def update_schema_references(apps, schema_editor):
    ...
    schema_list = ["HALF", "CUSTOM", "DYNAMIC", "RENT"]
    for schema in schema_list:
        fk_schema, _ = Schema.objects.get_or_create(title=schema)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(choices=[('RENT', 'Схема оренди'), ('HALF', 'Схема 50/50'), ('DYNAMIC', 'Динамічна схема'), ('CUSTOM', 'Індивідуальний відсоток')], max_length=25, verbose_name='Назва схеми')),
            ],
        ),
        ...
        migrations.AlterField(
            model_name='driver',
            name='schema',
            field=models.ForeignKey(default=app.models.Schema.get_half_schema_id, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.schema', verbose_name='Схема роботи'),
        ),
    ]
